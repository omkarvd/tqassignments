//Q3. Create a Account class having accid, name, balance, bankname, pan card. Create constructors and getter setters. 
...
public class Account {
	...
	public Account(int acid, String name, int balance, String bankname, int pancard) {
