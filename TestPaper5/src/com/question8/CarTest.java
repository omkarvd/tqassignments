...
public class CarTest {
	public static void main(String[] args) {
		...
		System.out.println(
				"Car 2: Model No = " + car2.getModelNo() + "," + " Machine Type = " + car2.getMachine().getMachineType()
						+ "," + " Engine Type = " + car2.getMachine().getEngine().getEngineType() + ", " + "Price = "
